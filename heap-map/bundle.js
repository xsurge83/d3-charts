...
/***/ function(module, exports, __webpack_require__) {
	...
	var DAYS = ['Mon', 'Tues', 'Wed', 'Thurs', 'Friday', 'Sat', 'Sun'];
	var MARGIN = {
	    top: 120,
	    right: 40,
	    bottom: 70,
	...
	var WIDTH = 725, HEIGHT = 300;
	var times = d3.range(24);
	var gridSize = WIDTH / times.length;
	...
	var mid = d3.max(data_1.default, function (d) { return d.count; }) / 2, max = d3.max(data_1.default, function (d) { return d.count; });
	...
	var HEADER = 'Number of Events', SUB_HEADER = 'The Netherlands | 2014';
	...
	var xScale = d3.scale.linear()
	    ...
	    .domain([0, d3.max(data_1.default, function (d) {
	        return d.count;
	    })]);
	//Define x-axis
